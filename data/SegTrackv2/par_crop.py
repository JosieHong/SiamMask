...
def crop_video(video, v, crop_path, data_path, instanc_size):
    ...
    for trackid, o in enumerate(list(v)):
        ...
        for frame in obj:
            ...
            img_name = listdir(join(img_base_path, file_name[:-6]))[0]
            img_path = join(img_base_path, file_name[:-6], img_name)   
